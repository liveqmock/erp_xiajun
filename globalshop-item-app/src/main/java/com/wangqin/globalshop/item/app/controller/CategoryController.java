...
public class CategoryController {
    ...
    /*
     * @RequestMapping("/edit")
     * @ResponseBody public Object edit(ItemCategoryDO category) { // Category categoryP = //
     * categoryService.findCategory(category.getId().intValue()); // categoryP.setName(category.getName()); //
     * categoryP.setSeq(category.getSeq()); // categoryP.setPid(category.getPid()); //
     * categoryP.setStatus(category.getStatus()); // categoryService.insertOrUpdate(categoryP);
     * categoryService.update(category); return renderSuccess("添加成功！"); }
     */
}
