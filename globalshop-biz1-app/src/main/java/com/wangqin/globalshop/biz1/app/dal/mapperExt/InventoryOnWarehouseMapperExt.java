...
public interface InventoryOnWarehouseMapperExt extends InventoryOnWareHouseDOMapper {
     ...
     * @return
     */
    List<InventoryOnWarehouseItemVO> listInventoryOnWarehouse(
            @Param("inventoryOnWarehouseQueryVO") InventoryOnWarehouseQueryVO inventoryOnWarehouseQueryVO,
     ...
     * @return
     */
    int countInventoryOnWarehouse(@Param("inventoryOnWarehouseQueryVO") InventoryOnWarehouseQueryVO inventoryOnWarehouseQueryVO);
}
