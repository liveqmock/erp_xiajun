...
import com.wangqinauth.model.User;
import com.wangqinauth.model.vo.UserVo;
import com.wangqinauth.service.IRoleService;
import com.wangqinauth.service.IUserService;
...
public class ShiroDbRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(
        ...
        ShiroUser shiroUser = new ShiroUser(user.getId(),user.getCompanyId(), user.getLoginName(), user.getName(), urls);
        shiroUser.setRoles(roles);
        shiroUser.setResCodes(resCodes);
        // 认证缓存信息
