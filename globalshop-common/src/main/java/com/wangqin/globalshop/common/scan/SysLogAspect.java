package com.wangqin.globalshop.common.scan;
...
//    @Around("cutController()")
    ...
    private boolean isWriteLog(String method) {
        String[] pattern = {"login", "logout", "add", "edit", "update", "delete", "grant", "lockedVirtualInv", "batchListingYouzan", "batchDelistingYouzan", "batchSynItemYouzan", "splitErpOrder"};
