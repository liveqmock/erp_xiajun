...
public class YouzanMsgPushEntity {
		...
		public String toString() {
			return "YouzanMsgPushEntity [msg=" + msg + ", sendCount=" + sendCount + ", mode=" + mode + ", app_id="
					+ app_id + ", client_id=" + client_id + ", version=" + version + ", type=" + type + ", id=" + id
					+ ", sign=" + sign + ", kdt_id=" + kdt_id + ", test=" + test + ", status=" + status + ", kdt_name="
					+ kdt_name + "]";
		}
