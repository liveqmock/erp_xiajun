...
public String getBuyerArea() {
    ...
    public void setOrders(YouzanTradeGetResult.TradeOrderV2[] orders) {
    this.orders = orders;
}

public YouzanTradeGetResult.TradeOrderV2[] getOrders() {
    return this.orders;
}

    public void setFetchDetail(YouzanTradeGetResult.TradeFetch fetchDetail) {
    this.fetchDetail = fetchDetail;
}

public YouzanTradeGetResult.TradeFetch getFetchDetail() {
    return this.fetchDetail;
}

    public void setCouponDetails(YouzanTradeGetResult.UmpTradeCoupon[] couponDetails) {
    this.couponDetails = couponDetails;
}

public YouzanTradeGetResult.UmpTradeCoupon[] getCouponDetails() {
    return this.couponDetails;
}

    public void setFansInfo(YouzanTradeGetResult.FansInfo fansInfo) {
    this.fansInfo = fansInfo;
}

public YouzanTradeGetResult.FansInfo getFansInfo() {
    return this.fansInfo;
}

    public void setHotelInfo(YouzanTradeGetResult.HotelInfo hotelInfo) {
    this.hotelInfo = hotelInfo;
}

public YouzanTradeGetResult.HotelInfo getHotelInfo() {
    return this.hotelInfo;
}

    public void setPromotionDetails(YouzanTradeGetResult.TradePromotion[] promotionDetails) {
    this.promotionDetails = promotionDetails;
}

public YouzanTradeGetResult.TradePromotion[] getPromotionDetails() {
    return this.promotionDetails;
}

    public void setAdjustFee(YouzanTradeGetResult.AdjustFee adjustFee) {
    this.adjustFee = adjustFee;
}

public YouzanTradeGetResult.AdjustFee getAdjustFee() {
